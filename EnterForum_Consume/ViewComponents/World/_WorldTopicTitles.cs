...
namespace EnterForum_Consume.ViewComponents.World

{
    public class _WorldTopicTitles : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _WorldTopicTitles(IHttpClientFactory httpClientFactory)
        {
